...
# Model Configuration - Using FREE local Ollama instead of OpenAI
USE_OLLAMA = True  # Set to False to use OpenAI, True for free local model
OLLAMA_MODEL = "llama3.2:1b"  # Free lightweight model
OLLAMA_BASE_URL = "http://localhost:11434"

# OpenAI Configuration (backup, will cost money)
